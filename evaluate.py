...
if __name__ == '__main__':
    ...
    # Initialize network
    net = highwayNet(args)
    net.load_state_dict(torch.load('trained_models/natr.tar'))
    if args['use_cuda']:
        net = net.cuda()
...
# lossVal is: tensor([ 167605.1250,  662173.3125, 1600158.2500, 3066066.2500, 5099735.5000],
#        device='cuda:0')
# tensor([0.1017, 0.2024, 0.3150, 0.4366, 0.5638], device='cuda:0')
